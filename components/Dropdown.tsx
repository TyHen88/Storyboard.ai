...
/**
 * Generic gear/label-triggered dropdown. The menu is rendered in a portal with
 * fixed positioning so it's never clipped by an ancestor's overflow-hidden or
 * transform (sidebar panel / animated ChatBar).
 */
export default function Dropdown({
  ...
  /** Uppercase label at the top of the menu. */
  header?: string;
  align?: 'left' | 'right';
  openUp?: boolean;
      ...
      {open &&
        ...
        createPortal(
          <div
            ...
            className="rounded-lg border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 shadow-xl p-1 max-h-[70vh] overflow-y-auto"
          >
            {header && (
              ...
              return (
                ...
                >
                  <span className="min-w-0 flex-1">
                    ...
                    {opt.hint && <span className="block text-[10px] text-gray-400 dark:text-zinc-500">{opt.hint}</span>}
                  </span>
